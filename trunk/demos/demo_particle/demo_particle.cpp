...
void april_init(const harray<hstr>& args)
{
	...
	try
	{
		...
		april::createRenderTarget((int)screen.w, (int)screen.h, false, "demo_particle");
		atres::init();
		aprilui::init();
...
#ifdef _HAVE_PARTICLE
		aprilui::setDefaultParticlesPath("");
		dataset = new aprilui::Dataset("../media/demo_particle.datadef");
		dataset->load();
#endif
#ifdef _DEBUG
