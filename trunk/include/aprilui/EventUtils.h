...
#define SET_MOUSEDOWN_EVENT(dataset, name, cls, member_func) \
	...
	dataset->getObject(name)->registerEvent(aprilui::Event::MOUSE_DOWN, new aprilui::MemberCallbackEvent<cls>(&cls::member_func, (cls*)this));
// for class member functions being registered from within the class
...
#define _SET_MOUSEDOWN_EVENT(obj, cls, member_func) \
	...
	obj->registerEvent(aprilui::Event::MOUSE_DOWN, new aprilui::MemberCallbackEvent<cls>(&cls::member_func, (cls*)this));
...
#define SET_MOUSEDOWN_EVENT_FUNCTION(dataset, obj_name, free_function) \
	...
	dataset->getObject(obj_name)->registerEvent(aprilui::Event::MOUSE_DOWN, new aprilui::CallbackEvent(free_function));
// for free C functions and static class functions
...
#define _SET_MOUSEDOWN_EVENT_FUNCTION(obj, free_function) \
	...
	obj->registerEvent(aprilui::Event::MOUSE_DOWN, new aprilui::CallbackEvent(free_function));
