...
namespace aprilui
{
	...
	hmap<hstr, PropertyDescription>& ScrollArea::getPropertyDescriptions() const
	{
		if (ScrollArea::_propertyDescriptions.size() == 0)
		{
			...
			ScrollArea::_propertyDescriptions["drag_threshold"] = PropertyDescription("drag_threshold", PropertyDescription::Type::Gvec2f);
			...
			ScrollArea::_propertyDescriptions["oob_children_fade_size_factor"] = PropertyDescription("oob_children_fade_size_factor", PropertyDescription::Type::Gvec2f);
			...
			ScrollArea::_propertyDescriptions["oob_children_fade_offset_factor"] = PropertyDescription("oob_children_fade_offset_factor", PropertyDescription::Type::Gvec2f);
	...
	hmap<hstr, PropertyDescription::Accessor*>& ScrollArea::_getGetters() const
	{
		if (ScrollArea::_getters.size() == 0)
		{
			...
			ScrollArea::_getters["drag_threshold"] = new PropertyDescription::GetGvec2f<ScrollArea>(&ScrollArea::getDragThreshold);
			...
			ScrollArea::_getters["oob_children_fade_size_factor"] = new PropertyDescription::GetGvec2f<ScrollArea>(&ScrollArea::getOobChildrenFadeSizeFactor);
			...
			ScrollArea::_getters["oob_children_fade_offset_factor"] = new PropertyDescription::GetGvec2f<ScrollArea>(&ScrollArea::getOobChildrenFadeOffsetFactor);
	...
	hmap<hstr, PropertyDescription::Accessor*>& ScrollArea::_getSetters() const
	{
		if (ScrollArea::_setters.size() == 0)
		{
			...
			ScrollArea::_setters["drag_threshold"] = new PropertyDescription::SetGvec2f<ScrollArea>(&ScrollArea::setDragThreshold);
			...
			ScrollArea::_setters["oob_children_fade_size_factor"] = new PropertyDescription::SetGvec2f<ScrollArea>(&ScrollArea::setOobChildrenFadeSizeFactor);
			...
			ScrollArea::_setters["oob_children_fade_offset_factor"] = new PropertyDescription::SetGvec2f<ScrollArea>(&ScrollArea::setOobChildrenFadeOffsetFactor);
