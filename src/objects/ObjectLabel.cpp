...
namespace aprilui
{
	...
	bool Label::triggerEvent(chstr name, unsigned int keyCode, chstr extra)
	{
		return Object::triggerEvent(name, keyCode, extra);
	}

	bool Label::triggerEvent(chstr name, float x, float y, unsigned int keyCode, chstr extra)
	{
