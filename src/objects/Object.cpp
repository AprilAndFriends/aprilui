...
namespace aprilui
{
	...
	harray<PropertyDescription> Object::getPropertyDescriptions()
	{
		...
		{
			Object::_propertyDescriptions += PropertyDescription("rect", PropertyDescription::TYPE_GRECT);
			Object::_propertyDescriptions += PropertyDescription("position", PropertyDescription::TYPE_GVEC2);
			Object::_propertyDescriptions += PropertyDescription("size", PropertyDescription::TYPE_GVEC2);
			Object::_propertyDescriptions += PropertyDescription("x", PropertyDescription::TYPE_FLOAT);
			...
			Object::_propertyDescriptions += PropertyDescription("alpha", PropertyDescription::TYPE_UCHAR);
			Object::_propertyDescriptions += PropertyDescription("color", PropertyDescription::TYPE_HEXCOLOR);
			Object::_propertyDescriptions += PropertyDescription("angle", PropertyDescription::TYPE_FLOAT);
			Object::_propertyDescriptions += PropertyDescription("scale", PropertyDescription::TYPE_GVEC2);
			Object::_propertyDescriptions += PropertyDescription("scale_x", PropertyDescription::TYPE_FLOAT);
			Object::_propertyDescriptions += PropertyDescription("scale_y", PropertyDescription::TYPE_FLOAT);
