...
namespace aprilui
{
	...
	void ColorImage::draw(cgrectf rect, const april::Color& color)
	{
		...
		this->vertices[0].color = april::rendersys->getNativeColorUInt(this->colorTopLeft * color);
		this->vertices[1].color = this->vertices[3].color = april::rendersys->getNativeColorUInt(this->colorTopRight * color);
		this->vertices[2].color = this->vertices[4].color = april::rendersys->getNativeColorUInt(this->colorBottomLeft * color);
		this->vertices[5].color = april::rendersys->getNativeColorUInt(this->colorBottomRight * color);
