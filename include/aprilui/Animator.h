...
namespace aprilui
{
	...
	public:
		...
		HL_INLINE float (*getCustomFunction())(Animator*, float) { return this->customFunction; }
		HL_INLINE void setCustomFunction(float (*value)(Animator*, float)) { this->customFunction = value; }
